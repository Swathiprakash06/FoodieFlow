...
urlpatterns = [
    ...
    path('update_menu/show_restaurant', views.show_restaurant, name='update_menu_show_restaurant'),
    path('remove_from_cart/<int:item_id>/<str:username>/', views.remove_from_cart, name='remove_from_cart'),
    path('update_menu/open_add_restaurant', views.open_add_restaurant, name='update_menu_open_add_restaurant'),
]
